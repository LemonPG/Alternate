/*
 ...
 Microsoft.VisualStudio.TestTools.CppUnitTestFramework API ÉäÉtÉ@ÉåÉìÉX
 */
#include "pch.h"
#include "TString.h"
...
namespace WindowsLibraryTest
{
	...
	public:
		...
		TEST_METHOD(FindTest3)
		{
			...
			alt::TString string = _T("àÎìÛéQélå‹òZéµî™ã„óÎçbâ≥ï∏íöïËå»çMêhêp·°");

			int t1 = string.Find(_T("éµî™ã„"));
			Assert::AreEqual(6, t1);

			int t2 = string.Find(_T("çbâ≥ï∏íö"));
			Assert::AreEqual(10, t2);

			int t3 = string.Find(_T("óÎàÎìÛ"));
		...
		TEST_METHOD(FromSJISTest)
		{
			...
			LPCSTR lpcszSJIS = "Ç±ÇÍÇÕSJISÇ≈çÏê¨Ç≥ÇÍÇΩï∂éöóÒÇ≈Ç∑ÅB\nàÎìÛéQélå‹òZéµî™ã„óÎ\n";
		...
		TEST_METHOD(ToSJISTest)
		{
			...
			LPCWSTR lpcwszUnicode = L"Ç±ÇÍÇÕUnicodeÇ≈çÏê¨Ç≥ÇÍÇΩï∂éöóÒÇ≈Ç∑ÅB\nàÎìÛéQélå‹òZéµî™ã„óÎ\n";
